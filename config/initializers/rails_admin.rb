# RailsAdmin config file. Generated on February 01, 2014 23:10
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Mail', 'Admin']
  ...
  # config.excluded_models = ['Account', 'AdminUser', 'Contact', 'Hierarchy', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Account', 'AdminUser', 'Contact', 'Hierarchy', 'User']
  ...
  #     configure :hierarchy, :belongs_to_association 
  #     configure :user, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :kanjiname, :string 
  #     configure :kananame, :string 
  #     configure :mail_addr, :string 
  #     configure :hierarchy_id, :integer         # Hidden 
  ...
  # config.model 'Hierarchy' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your hierarchy.rb model definition
  ...
  #     configure :id, :integer 
  #     configure :p_id, :integer 
  #     configure :gname, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
